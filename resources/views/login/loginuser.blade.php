...
<body>
    <section class="=login-section">
        ...
        <p class="text-create-account">Don't have an account?<a href="{{route('register')}}" class="textclick"> Register</a></p>
        <p class="text-create-account">Back To <a href="{{route('login')}}" class="textclick">Login Page</a></p>
    </section>
</body>
</html>