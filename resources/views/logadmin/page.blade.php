...
<body id="page-top">
    ...
    <div id="wrapper"> 
        <ul style="background-color:deepskyblue;" class="navbar-nav  sidebar sidebar-dark accordion" id="accordionSidebar">

            <div class="sidebar-header d-flex justify-content-left align-items-center px-3 py-4">
                <img
                    class="rounded-pill img-fluid"
                    width="65"
                    src="/img/logoprofile.svg"
                    alt="">
                <div class="ms-2">
                <h5 class="fs-6 mb-0">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{ url('tourguide/DaftarRestoran/create') }}">Tambah Baru</a>
                        <a class="collapse-item" href="{{ url('tourguide/DaftarRestoran') }}">Tampilkan Semua</a>
                    </div>
                </div>
            </li>
